...
define([ 
  ...
  var CalciteMaps = declare(null, {
    ...
    stickyDropdownDesktop: true, // This option should be true for accessibility purposes
        ...
        if (isPanel) {
          ...
          if (panel) {
            if (e.keyCode === 13) {
              ...
              document.getElementsByClassName("panel-close")[0].focus();
              // focusUtil.focus(panel.query(".panel-close")[0]);
            }
          } 
